...
//  屌丝男女的日常
//
//  Created by 李璐 on 16/2/25.
//  Copyright © 2016年 李璐. All rights reserved.
//

#ifndef LLDSHeadFile_h
#define LLDSHeadFile_h
#pragma mark -- 颜色
...
// 接口域名前缀
#define BASEURL @"http://api.budejie.com/"
// app 接口常量
#define YOURL @"http://wap.yojianzhi.com/app_api.php"
// 请求接口
#define WAPURL @"http://wap.yojianzhi.com/index.php"
// 首页轮播图接口图片基本链接
